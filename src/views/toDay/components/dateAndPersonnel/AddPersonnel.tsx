...
type FormList = [FormInputType, FormSelectType];
type PostOptions = {
	value: number;
	label: string;
};
...
const AddPersonnel: FC<AddPersonnelProps> = ({ form, addPersonnelOpen, addPersonnelLoading, onOk, onCancel }) => {
	const formList: FormList = [
		...
		},
		{
			...
			span: 12,
			formItemProps: { name: 'post', label: '岗位', labelCol: { span: 6 }, wrapperCol: { span: 18 } }
		}
	];
