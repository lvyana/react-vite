...
const VirtualScroll = <T,>({ className, config, readerComponent }: VirtualScrollProps<T>) => {
	...
	return (
		<div className={className} ref={containerRef} style={{ height: containerHeight, overflowY: 'auto' }} onScroll={handleScroll}>
